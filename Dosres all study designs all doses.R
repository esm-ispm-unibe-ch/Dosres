...
cat(paste("RESULT: The RR for response between doses 10 mg and 40 mg is",round(predict(doseresRR,delta=40,exp=T)[2]/predict(doseresRR,delta=10,exp=T)[2],3), "\n"))
...
print(summary(doseresRR))
cat(paste("RESULT: The RR for dropout between doses 10 mg and 40 mg is",round(predict(doseresRR,delta=40,exp=T)[2]/predict(doseresRR,delta=10,exp=T)[2],3), "\n"))
...
print(summary(doseresRR))
cat(paste("RESULT: The RR for AEdropout between doses 10 mg and 40 mg is",round(predict(doseresRR,delta=40,exp=T)[2]/predict(doseresRR,delta=10,exp=T)[2],3), "\n"))
